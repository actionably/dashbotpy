...
htmlhelp_basename = 'scrubadubdoc'
...
latex_documents = [
  ('index', 'scrubadub.tex', u'scrubadub Documentation',
...
man_pages = [
    ('index', 'scrubadub', u'scrubadub Documentation',
     [u'Dean Malmgren'], 1)
]
...
texinfo_documents = [
  ('index', 'scrubadub', u'scrubadub Documentation',
   u'Dean Malmgren', 'scrubadub', 'One line description of project.',
   'Miscellaneous'),
]
